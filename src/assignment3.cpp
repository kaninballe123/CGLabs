...
edaf80::Assignment3::run()
{
	...
	program_manager.CreateAndRegisterProgram("Phong", { { ShaderType::vertex, "EDAF80/phong.vert" },
	...
	GLuint normalmap_shader = 0u;
	program_manager.CreateAndRegisterProgram("Normalmap", { { ShaderType::vertex, "EDAF80/normalmap.vert" },
											   { ShaderType::fragment, "EDAF80/normalmap.frag" } },
		normalmap_shader);
	if (normalmap_shader == 0u) {
		LogError("Failed to load normalmap shader");
	}
	...
	auto my_texture_diffuse = bonobo::loadTexture2D(config::resources_path("textures/leather_red_02_coll1_2k.jpg"), true);
	demo_sphere.add_texture("my_texture2", my_texture_diffuse, GL_TEXTURE_2D);
	auto my_texture_specular = bonobo::loadTexture2D(config::resources_path("textures/leather_red_02_rough_2k.jpg"), true);
	auto my_texture_normal = bonobo::loadTexture2D(config::resources_path("textures/leather_red_02_nor_2k.jpg"), true);
	
	demo_sphere.add_texture("my_texture1", my_texture_specular, GL_TEXTURE_2D);
	demo_sphere.add_texture("my_texture3", my_texture_normal, GL_TEXTURE_2D);

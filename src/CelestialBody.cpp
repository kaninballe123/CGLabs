	...
	
{
	...
	glm::mat4 T0 = glm::translate(ModelMatrix, glm::vec3(_body.orbit.radius ,0, 0));
	glm::mat4 R2s = glm::rotate(ModelMatrix, _body.spin.axial_tilt, glm::vec3(0.0f, 0.0f, 1.0f));
	glm::mat4 R1s = glm::rotate(ModelMatrix, _body.spin.rotation_angle, glm::vec3(0.0f, 1.0f, 0.0f));
	glm::mat4 scale = glm::scale(ModelMatrix, _body.scale);
	glm::mat4 R1o = glm::rotate(ModelMatrix, _body.orbit.rotation_angle, glm::vec3(0.0f, 1.0f, 0.0f));
	glm::mat4 R2o = glm::rotate(ModelMatrix, _body.orbit.inclination, glm::vec3(0.0f, 0.0f, 1.0f));

	glm::mat4 world = parent_transform * R2o * R1o * T0 * R2s * R1s * scale;
	if (show_basis)
	{
	...
	return parent_transform * R2o * R1o * T0 * R2s;
}
